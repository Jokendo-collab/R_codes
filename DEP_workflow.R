...
setwd("/home/javan/Desktop/DEP/clemensData/susceptiblePhynotype/")
...
data = read.table("susceptiblePhe_proteinGroups.txt",header = T,sep = '\t',stringsAsFactors = FALSE)
...
experimental_design <- read.table("suscptibleExperimentalGroups.txt",sep = '\t',header = T,stringsAsFactors = FALSE)
...
data_diff <- test_diff(data_imp, type = "control", control = "PPD")
...
plot_volcano(dep, contrast = "baseline_vs_PPD", label_size = 3, add_names = TRUE)
