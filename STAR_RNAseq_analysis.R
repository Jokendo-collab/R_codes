##This step follows after the NGS analysis of the RNAseq data
##Install the required packages
#===============================================================================
# This the url for the tutorial: https://github.com/javanOkendo/RNAseq-workflow
# Another link is here from nf-core: https://github.com/nf-core/atacseq/blob/master/bin/featurecounts_deseq2.r
...
#Annotate gene symbols (Generate the annotation information)
...
# First Set up matrix to take into account EntrezID's and fold changes for each gene
